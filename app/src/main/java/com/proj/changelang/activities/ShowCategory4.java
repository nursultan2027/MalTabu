...
//        Fragment frag1 = getFragmentManager().findFragmentByTag(String.valueOf(tabLayout.getTabAt(selectedTab).getText()));


//        Fragment fragment = null;
//        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
//            fragment = getFragmentManager().getFragments().get(selectedTab);
//        }
        //        ((ListView) fragment.getView().findViewById(R.id.prodss
...
//        });
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        String [] catalogStr = {"5ab672c9559d5e049c25a63a", "5ab672c9559d5e049c25a63b"};
        bundle1.putString("catalog", "5ab672c9559d5e049c25a639");
