...
//        }
    ...
    private class HTTPAsyncTask7 extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... urls) {
            try {
                try {
                    return HttpPost7("http://maltabu.kz/v1/api/clients/posts");
                } catch (JSONException e) {
                    e.printStackTrace();
                    return "Error!";
                }
    ...
    private String HttpPost7(String myUrl) throws IOException, JSONException {
        StringBuilder res = new StringBuilder();
        URL url = new URL(myUrl);
        HttpURLConnection conn = (HttpURLConnection) url.openConnection();
        conn.setRequestMethod("POST");
        ...
        conn.setRequestProperty("isAuthorized", "false");
        conn.setDoOutput(true);
        JSONObject jsonObject = buidJsonObject7();
        setPostRequestContent(conn, jsonObject);
        conn.connect();
    ...
    private JSONObject buidJsonObject7() throws JSONException {
