...
public class ShowCategory3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HTTPAsyncTask4 task3 = new HTTPAsyncTask4();
...
//        }
    ...
    private JSONObject buidJsonObject() throws JSONException {
        ...
        jsonObject.accumulate("categoryID", "5ab672c9559d5e049c25a633");
    ...
    private JSONObject buidJsonObject2() throws JSONException {
        ...
        JSONObject jsonObject = new JSONObject();
        jsonObject.accumulate("byTime", true);
        jsonObject.accumulate("catalogID", "5ab672c9559d5e049c25a634");
        jsonObject.accumulate("countPosts", true);
        jsonObject.accumulate("increment", true);
        jsonObject.accumulate("onlyEmergency", false);
        jsonObject.accumulate("onlyExchange", false);
    ...
    private JSONObject buidJsonObject3() throws JSONException {
        ...
        JSONObject jsonObject = new JSONObject();
        jsonObject.accumulate("byTime", true);
        jsonObject.accumulate("catalogID", "5ab672c9559d5e049c25a635");
        jsonObject.accumulate("countPosts", true);
        jsonObject.accumulate("increment", true);
        jsonObject.accumulate("onlyEmergency", false);
        jsonObject.accumulate("onlyExchange", false);
    ...
    private class HTTPAsyncTask4 extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... urls) {
            try {
                try {
                    return HttpPost4("http://maltabu.kz/v1/api/clients/posts");
                } catch (JSONException e) {
                    e.printStackTrace();
                    return "Error!";
                }
    ...
    private String HttpPost4(String myUrl) throws IOException, JSONException {
        StringBuilder res = new StringBuilder();
        URL url = new URL(myUrl);
        HttpURLConnection conn = (HttpURLConnection) url.openConnection();
        conn.setRequestMethod("POST");
        ...
        conn.setRequestProperty("isAuthorized", "false");
        conn.setDoOutput(true);
        JSONObject jsonObject = buidJsonObject4();
        setPostRequestContent(conn, jsonObject);
        conn.connect();
    ...
    private JSONObject buidJsonObject4() throws JSONException {

        JSONObject jsonObject = new JSONObject();
        jsonObject.accumulate("byTime", true);
        jsonObject.accumulate("catalogID", "5ab672c9559d5e049c25a636");
        jsonObject.accumulate("countPosts", true);
        jsonObject.accumulate("increment", true);
        jsonObject.accumulate("onlyEmergency", false);
        jsonObject.accumulate("onlyExchange", false);
    ...
    private class HTTPAsyncTask5 extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... urls) {
            try {
                try {
                    return HttpPost5("http://maltabu.kz/v1/api/clients/posts");
                } catch (JSONException e) {
                    e.printStackTrace();
                    return "Error!";
                }
    ...
    private String HttpPost5(String myUrl) throws IOException, JSONException {
        StringBuilder res = new StringBuilder();
        URL url = new URL(myUrl);
        HttpURLConnection conn = (HttpURLConnection) url.openConnection();
        conn.setRequestMethod("POST");
        ...
        conn.setRequestProperty("isAuthorized", "false");
        conn.setDoOutput(true);
        JSONObject jsonObject = buidJsonObject5();
        setPostRequestContent(conn, jsonObject);
        conn.connect();
    ...
    private JSONObject buidJsonObject5() throws JSONException {

        JSONObject jsonObject = new JSONObject();
        jsonObject.accumulate("byTime", true);
        jsonObject.accumulate("catalogID", "5ab672c9559d5e049c25a637");
        jsonObject.accumulate("countPosts", true);
        jsonObject.accumulate("increment", true);
        jsonObject.accumulate("onlyEmergency", false);
        jsonObject.accumulate("onlyExchange", false);
    ...
    private class HTTPAsyncTask6 extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... urls) {
            try {
                try {
                    return HttpPost6("http://maltabu.kz/v1/api/clients/posts");
                } catch (JSONException e) {
                    e.printStackTrace();
                    return "Error!";
                }
    ...
    private String HttpPost6(String myUrl) throws IOException, JSONException {
        StringBuilder res = new StringBuilder();
        URL url = new URL(myUrl);
        HttpURLConnection conn = (HttpURLConnection) url.openConnection();
        conn.setRequestMethod("POST");
        ...
        conn.setRequestProperty("isAuthorized", "false");
        conn.setDoOutput(true);
        JSONObject jsonObject = buidJsonObject6();
        setPostRequestContent(conn, jsonObject);
        conn.connect();
    ...
    private JSONObject buidJsonObject6() throws JSONException {

        JSONObject jsonObject = new JSONObject();
        jsonObject.accumulate("byTime", true);
        jsonObject.accumulate("catalogID", "5ab672c9559d5e049c25a638");
        jsonObject.accumulate("countPosts", true);
        jsonObject.accumulate("increment", true);
        jsonObject.accumulate("onlyEmergency", false);
        jsonObject.accumulate("onlyExchange", false);
