...
public class PostBodyHelper {
    ...
    public RequestBody getBody(){
        ...
        if(files.size()==1&&phones.size()==1) {
            body = new MultipartBody.Builder()
                    .setType(MultipartBody.FORM)
                    .addFormDataPart("images[0]", files.get(0).getName(), RequestBody.create(MediaType.parse("image/jpg"), files.get(0)))
                    .addFormDataPart("title", title)
                    .addFormDataPart("exchange", exchange)
                    .addFormDataPart("phones[0]", phones.get(0))
                    .addFormDataPart("mail", email)
        ...
        if(files.size()==2&&phones.size()==1) {
            body = new MultipartBody.Builder()
                    .setType(MultipartBody.FORM)
                    .addFormDataPart("images[0]", files.get(0).getName(), RequestBody.create(MediaType.parse("image/jpg"), files.get(0)))
                    .addFormDataPart("images[1]", files.get(1).getName(), RequestBody.create(MediaType.parse("image/jpg"), files.get(1)))
                    .addFormDataPart("title", title)
                    .addFormDataPart("exchange", exchange)
                    .addFormDataPart("phones[0]", phones.get(0))
                    .addFormDataPart("mail", email)
        ...
        if(files.size()==3&&phones.size()==1) {
            body = new MultipartBody.Builder()
                    ...
                    .addFormDataPart("images[0]", files.get(0).getName(), RequestBody.create(MediaType.parse("image/jpg"), files.get(0)))
                    .addFormDataPart("images[1]", files.get(1).getName(), RequestBody.create(MediaType.parse("image/jpg"), files.get(1)))
                    .addFormDataPart("images[2]", files.get(2).getName(), RequestBody.create(MediaType.parse("image/jpg"), files.get(2)))
                    .addFormDataPart("title", title)
                    .addFormDataPart("exchange", exchange)
                    .addFormDataPart("phones[0]", phones.get(0))
                    .addFormDataPart("mail", email)
        ...
        if(files.size()==4&&phones.size()==1) {
            body = new MultipartBody.Builder()
                    ...
                    .addFormDataPart("images[1]", files.get(1).getName(), RequestBody.create(MediaType.parse("image/jpg"), files.get(1)))
                    .addFormDataPart("images[2]", files.get(2).getName(), RequestBody.create(MediaType.parse("image/jpg"), files.get(2)))
                    .addFormDataPart("images[3]", files.get(3).getName(), RequestBody.create(MediaType.parse("image/jpg"), files.get(3)))
                    .addFormDataPart("title", title)
                    .addFormDataPart("exchange", exchange)
                    .addFormDataPart("phones[0]", phones.get(0))
                    .addFormDataPart("mail", email)
        ...
        if(files.size()==5&&phones.size()==1) {
            body = new MultipartBody.Builder()
                    ...
                    .addFormDataPart("images[2]", files.get(2).getName(), RequestBody.create(MediaType.parse("image/jpg"), files.get(2)))
                    .addFormDataPart("images[3]", files.get(3).getName(), RequestBody.create(MediaType.parse("image/jpg"), files.get(3)))
                    .addFormDataPart("images[4]", files.get(4).getName(), RequestBody.create(MediaType.parse("image/jpg"), files.get(4)))
                    .addFormDataPart("title", title)
                    .addFormDataPart("exchange", exchange)
                    .addFormDataPart("phones[0]", phones.get(0))
                    .addFormDataPart("mail", email)
        ...
        if(files.size()==6&&phones.size()==1) {
            body = new MultipartBody.Builder()
                    ...
                    .addFormDataPart("images[3]", files.get(3).getName(), RequestBody.create(MediaType.parse("image/jpg"), files.get(3)))
                    .addFormDataPart("images[4]", files.get(4).getName(), RequestBody.create(MediaType.parse("image/jpg"), files.get(4)))
                    .addFormDataPart("images[5]", files.get(5).getName(), RequestBody.create(MediaType.parse("image/jpg"), files.get(5)))
                    .addFormDataPart("title", title)
                    .addFormDataPart("exchange", exchange)
                    .addFormDataPart("phones[0]", phones.get(0))
                    .addFormDataPart("mail", email)
        ...
        if(files.size()==7&&phones.size()==1) {
            body = new MultipartBody.Builder()
                    ...
                    .addFormDataPart("images[4]", files.get(4).getName(), RequestBody.create(MediaType.parse("image/jpg"), files.get(4)))
                    .addFormDataPart("images[5]", files.get(5).getName(), RequestBody.create(MediaType.parse("image/jpg"), files.get(5)))
                    .addFormDataPart("images[6]", files.get(6).getName(), RequestBody.create(MediaType.parse("image/jpg"), files.get(6)))
                    .addFormDataPart("title", title)
                    .addFormDataPart("exchange", exchange)
                    .addFormDataPart("phones[0]", phones.get(0))
                    .addFormDataPart("mail", email)
        ...
        if(files.size()==8&&phones.size()==1) {
            body = new MultipartBody.Builder()
                    ...
                    .addFormDataPart("images[5]", files.get(5).getName(), RequestBody.create(MediaType.parse("image/jpg"), files.get(5)))
                    .addFormDataPart("images[6]", files.get(6).getName(), RequestBody.create(MediaType.parse("image/jpg"), files.get(6)))
                    .addFormDataPart("images[7]", files.get(7).getName(), RequestBody.create(MediaType.parse("image/jpg"), files.get(7)))
                    .addFormDataPart("title", title)
                    .addFormDataPart("exchange", exchange)
                    .addFormDataPart("phones[0]", phones.get(0))
                    .addFormDataPart("mail", email)
